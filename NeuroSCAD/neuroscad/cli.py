...
def main() -> None:
    ...
    val = sub.add_parser("validate"); val.add_argument("ir", type=Path); val.add_argument("--render", action="store_true"); val.add_argument("--sweep", action="store_true")
    ...
    if args.command == "generate":
        ...
        if args.command == "validate":
            report = validate_parameter_sweep(program, render=args.render) if args.sweep else validate_program(program, render=args.render)
